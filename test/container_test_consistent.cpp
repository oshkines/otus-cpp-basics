...
TEST(ConsistentContainer, Empty) {

    ConsistentContainer<int> Container{ 10 };
    ASSERT_EQ(Container.getSize(), 0); //���������, ����� �� ��� �������� (val1 == val2).  
...
TEST(ConsistentContainer, PushBack) {
    // Arrange
    const size_t expected = 10;
    ConsistentContainer<int> Container{ expected };
...
TEST(ConsistentContainer, RemoveTest) {
    // Arrange
    int ArrDelete[] = { 3, 5, 7 }; // � ������� ��������� �����, � �� ������ ��� ��������� ������� ����� �������
    ConsistentContainer<int> Container{ 10 };
    const size_t expected = 10;
...
TEST(ConsistentContainer, RemoveTestTwo) {
    // Arrange
    ConsistentContainer<int> Container{ 10 };
    const size_t expected = 10;
    for (size_t i = 0; i < expected; ++i)
...
TEST(ConsistentContainer, Insert) {
    // Arrange
    const size_t expected = 10;
    ConsistentContainer<int> Container{ expected };
...
TEST(ConsistentContainer, InsertTwo) {
    // Arrange
    const size_t expected = 10;
    ConsistentContainer<int> Container{ expected };
 ...
 TEST(ConsistentContainer, ClearContainer){
     // Arrange
     const size_t expected = 10;
     ConsistentContainer<int> Container{ expected };
     for (size_t i = 0; i < expected; ++i)
 ...
 TEST(ConsistentContainer, RemoveOne){
     // Arrange
     const size_t expected = 10;
     ConsistentContainer<int> Container{ expected };
     for (size_t i = 0; i < expected; ++i)
 ...
 TEST(ConsistentContainer, RemoveMiddle){
     // Arrange
     const size_t expected = 10;
     ConsistentContainer<int> Container{ expected };
     for (size_t i = 0; i < expected; ++i)
 ...
 TEST(ConsistentContainer, RemoveEnding){
     // Arrange
     const size_t expected = 10;
     ConsistentContainer<int> Container{ expected };
     for (size_t i = 0; i < expected; ++i)
 ...
 TEST(ConsistentContainer, Operator_KvSk){
     // Arrange
